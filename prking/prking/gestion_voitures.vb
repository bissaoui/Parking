Public Class gestion_voitures
    Dim cnp As Integer = 10
    Private Sub GroupBox1_Enter(sender As Object, e As EventArgs) Handles GroupBox1.Enter

    End Sub

    Private Sub gestion_voitures_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.SelectedIndexChanged
        If ListView1.SelectedItems.Count > 0 Then
            ...
            If RadioButton1.Text = ListView1.SelectedItems(0).SubItems.Item(3).Text Then
                RadioButton1.Checked = True
            ElseIf RadioButton2.Text = ListView1.SelectedItems(0).SubItems.Item(3).Text Then
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim element_voiture As New ListViewItem(chauffeur)
            element_voiture.SubItems.Add(imma)
            element_voiture.SubItems.Add(nbAssure)
            element_voiture.SubItems.Add(marque)
            element_voiture.SubItems.Add(dateEntree)
            element_voiture.SubItems.Add(dateSortie)
            ListView1.Items.Add(element_voiture)
            id_autre.Text = ""
            id_imm.Text = ""
            id_chauf.Text = ""
            cnp = cnp - 1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If ListView1.SelectedItems.Count > 0 Then
            ...
            Dim dateEntree As String = id_datE.Value
            Dim dateSortie As String = "-"
            ' Fin de l'etape du récupération des données 
            Dim element_voiture As New ListViewItem(chauffeur)
            element_voiture.SubItems.Add(imma)
            element_voiture.SubItems.Add(nbAssure)
            element_voiture.SubItems.Add(marque)
            element_voiture.SubItems.Add(dateEntree)
            element_voiture.SubItems.Add(dateSortie)
            ' ListView1.Items.Add(element_voiture) cette ligne c'est pour  ajouter un item
            ListView1.Items(ListView1.SelectedIndices(0)) = element_voiture
            id_autre.Text = ""
            id_imm.Text = ""
            id_chauf.Text = ""
            cnp = cnp - 1
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If ListView1.SelectedItems.Count > 0 Then
            ...
            MessageBox.Show(" Vous voulez supprimer la voiture!")
